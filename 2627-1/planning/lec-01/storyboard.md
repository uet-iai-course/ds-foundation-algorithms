...
| A07 | Bất biến tiền tố chứng minh tính đúng | Tập khóa, giá trị, ba bước chứng minh | Dựng từ A05–A06 | 4 | Tính đúng chưa đủ để khả thi |
...
| B06 | Mô hình và giải thuật trong lọc thư | Dịch Ví dụ 1.1 | MMDS tr.2 | 2 | Kiểm tra bằng bảng tổng |
| B07 | Phân loại sản phẩm tính toán | Câu hỏi hẹp về bảng tổng | MMDS tr.2–5 | 1 | Chuyển sang mô hình chi phí |
...
| C05 | Phép đánh đổi phải nằm trong đặc tả | Giữ, giảm, chấp nhận và câu kiểm tra | MMDS tr.3–4,13 | 3 | Nhiều dữ liệu tăng số phép thử |
| D00 | Tín hiệu giả trong dữ liệu lớn | Mở phần về nhiều phép thử | MMDS tr.5–6 | 2 | Đặt tình huống trước công thức |
| D01 | Mẫu trùng trong hồ sơ lưu trú | $P,T,H,q$; cùng khách sạn từng ngày, có thể khác qua ngày | MMDS tr.7 | 5 | Phát biểu mô hình ngẫu nhiên |
...
| D03 | Nguyên lý Bonferroni đếm biến cố trùng kỳ vọng | $E[X]=\binom P2\binom T2(q^2/H)^2$ | MMDS tr.6–8 | 6 | Thay dữ kiện cơ sở |
| D04 | Kỳ vọng có khoảng hai trăm năm mươi nghìn biến cố trùng | 249.750 biến cố; cặp người chỉ xấp xỉ khi hiếm | MMDS tr.8 | 6 | Kiểm tra độ nhạy không giải bài tập |
| D05 | Thay đổi quy mô quan sát | Chỉ phân loại tác động; không tiết lộ đáp số | MMDS Bài 1.2.1, tr.8 | 6 | Định tuyến số chiều lớn |
...
| R05 | Chữa Bài 1.2.2 | Định nghĩa $X$ là số cặp lượt mua; đáp án trong fragment | MMDS Bài 1.2.2, tr.8 | 15 | Kết thúc bằng giới hạn mô hình |
