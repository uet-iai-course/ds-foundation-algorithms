...
Bản hiện hành có **40 trang giảng và 8 trang bài tập**, thiết kế **120 phút giảng + 60 phút recitation**. Phân bổ dự kiến, chưa diễn tập với lớp thật. Bỏ quan hệ, chọn, chiếu, nối, tổng hợp và liên hệ nhân hai ma trận (2.3.3–2.3.10), các ví dụ chi phí nối của 2.5.3 và bài 2.5.1(c) theo chỉ dẫn mới về tiên quyết. Không giữ phép nối ngầm trong bài tập hoặc phần kết. Thời gian chuyển sang giải thích hai hàm, vết chạy và đếm chi phí; không thêm số liệu ngoài nguồn.
...
| 2.2 | Đếm từ → vết phát/nhóm/cộng → hai chữ ký → hình luồng → giả mã và đúng → thực thi. | 26 |
| 2.3 | Đổi khóa từ từ sang hàng → vết các tích → giả mã → chia dải vector. | 20 |
| 2.4 | Một công việc → đồ thị phụ thuộc → Spark/tính lại → nhiều tác vụ cần đánh giá. | 15 |
| 2.5 | Mô hình/đơn vị → đếm từ → đọc dải vector → tổng và tải lớn nhất. | 21 |
| 2.6 | Giới hạn tác vụ → đặc tả ảnh → từng cặp → nhóm ảnh → đúng và bộ nhớ. | 17 |
| 2.7 | Thu hồi các lớp lập luận → bốn sản phẩm tự kiểm tra. | 5 |
| 2.8 | Nguồn/hướng đọc → bài tập từ giáo trình. | 1 |

## Chu trình và nguồn

- Đếm từ: s02-01 đặt vấn đề; 02/03 chạy vết; 03a hình thức hóa; 03b nối hai hàm bằng sơ đồ; 04 giả mã; 04a tính đúng; 05–07 gộp, tải và chạy lại. D1 “dữ liệu lớn”, D2 “lớn lớn” là ví dụ Việt hóa đã có, minh họa Ví dụ 2.1–2.2, trang 25–27. Số 1 biểu diễn từng lần xuất hiện; không loại lặp. Hình dựa Hình 2.2, không đồng nhất mỗi hàm với một máy. Kiểm tra ở 02/06 và tổng kết; chi phí dùng lại cùng 5 cặp ở s05-03.
- Ma trận–vector: s03-01 đặc tả từ tiên quyết; 02 vết ký hiệu; 02a giả mã, giả thiết và đúng; 03 chia dải (Hình 2.4). Không tự đặt ma trận số ngoài nguồn. 2.5 quay lại dữ liệu này: mỗi phần tử đọc một lần, mỗi tác vụ đọc dải vector cần dùng. s05-03a định nghĩa đơn vị/kích thước và đếm; 03b cộng rồi xét trường hợp. Bài 2.5.1(a) yêu cầu giải thích mỗi số hạng và điều kiện. Số học chính xác; hàng không lưu hiểu bằng 0.
- Cặp ảnh: s06-00 đặc tả theo 2.6.2; 01 định nghĩa q/rho; 02 từng cặp; 03 từng nhóm; 03a bao phủ cặp chéo/nội bộ; 04 kiểm tra bộ nhớ. Giữ dữ kiện nguồn một triệu ảnh, một triệu byte mỗi ảnh và 1000 nhóm đều; không giảm số so sánh. Không cần phép nối quan hệ để theo dõi phân công ảnh.
...
- 9 SVG được dùng: mạng tủ máy; khối/bản sao; khóa–tác vụ; luồng Map–nhóm–Reduce mới; dải ma trận; đồ thị công việc; Spark; chi phí; nhóm ảnh. Hai SVG phép nối cũ không còn được nhúng, giữ tệp để truy nguyên lịch sử. Hình mới có nhãn và mũi tên, giữ lặp, không dùng màu làm tín hiệu duy nhất.
...
- **Kết nối vào–ra:** từ “Giới hạn một máy ở Bài 1”; chuẩn bị “Nội dung bài giảng”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
...
- **Kết nối vào–ra:** từ “MapReduce và ngăn xếp xử lý dữ liệu lớn”; chuẩn bị “Mục tiêu học tập”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Nội dung bài giảng”; chuẩn bị “2.1 · Cụm máy và mạng kết nối”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Mục tiêu học tập”; chuẩn bị “Lỗi máy và lỗi kết nối”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
...
- **Kết nối vào–ra:** từ “2.1 · Cụm máy và mạng kết nối”; chuẩn bị “Chia khối, lưu bản sao và đọc gần dữ liệu”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
- **Nguồn:** MMDS, Chương 2, 2.1, trang in 22–24.
...
- **Kết nối vào–ra:** từ “Lỗi máy và lỗi kết nối”; chuẩn bị “2.2 · Mô hình MapReduce”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** SVG có nhãn và chiều luồng.
- **Nguồn:** MMDS, Chương 2, 2.1, trang in 22–24.
...
- **Kết nối vào–ra:** từ “Chia khối, lưu bản sao và đọc gần dữ liệu”; chuẩn bị “Mỗi lần xuất hiện tạo một đóng góp”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “2.2 · Mô hình MapReduce”; chuẩn bị “Nhóm theo khóa rồi cộng”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Mỗi lần xuất hiện tạo một đóng góp”; chuẩn bị “Hai hàm của MapReduce”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Nhóm theo khóa rồi cộng”; chuẩn bị “Từ Map đến Reduce”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Hai hàm của MapReduce”; chuẩn bị “Thuật toán đếm từ”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** SVG có nhãn và chiều luồng.
...
- **Kết nối vào–ra:** từ “Từ Map đến Reduce”; chuẩn bị “Bộ đếm trả đúng số lần xuất hiện”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Thuật toán đếm từ”; chuẩn bị “Gộp cục bộ trước khi truyền”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Bộ đếm trả đúng số lần xuất hiện”; chuẩn bị “Khóa, tác vụ và máy”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Gộp cục bộ trước khi truyền”; chuẩn bị “Lưu trữ quyết định phần cần chạy lại”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** SVG có nhãn và chiều luồng.
- **Nguồn:** MMDS, Chương 2, Khung reducer/tác vụ/máy, trang in 28; 2.2.5.
- **Ghi chú:** [Giả thiết, lập luận và đáp án](../../lecture-02-mapreduce-va-ngan-xep-xu-ly-du-lieu-lon.html#/lec02-s02-06).
- **Thời lượng:** 2 phút giảng.
...
- **Kết nối vào–ra:** từ “Khóa, tác vụ và máy”; chuẩn bị “2.3 · Nhân ma trận–vector”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
- **Nguồn:** MMDS, Chương 2, 2.2.5–2.2.6, trang in 28–30.
- **Ghi chú:** [Giả thiết, lập luận và đáp án](../../lecture-02-mapreduce-va-ngan-xep-xu-ly-du-lieu-lon.html#/lec02-s02-07).
- **Thời lượng:** 2 phút giảng.
...
- **Kết nối vào–ra:** từ “Lưu trữ quyết định phần cần chạy lại”; chuẩn bị “Khóa hàng gom đúng các tích”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “2.3 · Nhân ma trận–vector”; chuẩn bị “Giả mã nhân ma trận–vector”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
- **Nguồn:** MMDS, Chương 2, 2.3.1, trang in 31–32.
...
- **Kết nối vào–ra:** từ “Khóa hàng gom đúng các tích”; chuẩn bị “Chia dải khi vector không vừa bộ nhớ”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
- **Nguồn:** MMDS, Chương 2, 2.3.1, trang in 31–32.
...
- **Kết nối vào–ra:** từ “Giả mã nhân ma trận–vector”; chuẩn bị “2.4 · Luồng công việc nhiều hàm”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** SVG có nhãn và chiều luồng.
...
- **Kết nối vào–ra:** từ “Chia dải khi vector không vừa bộ nhớ”; tạo cơ sở cho “Bài tập 2.3.1(b) · Trung bình các số nguyên”. Bài tập dùng sau phần giảng qua liên kết.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Bài tập 2.3.1(a) · Số nguyên lớn nhất”; tạo cơ sở cho “Bài tập 2.3.1(c) · Mỗi số chỉ xuất hiện một lần”. Bài tập dùng sau phần giảng qua liên kết.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Chia dải khi vector không vừa bộ nhớ”; chuẩn bị “Spark: Map và Flatmap”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** SVG có nhãn và chiều luồng.
...
- **Kết nối vào–ra:** từ “2.4 · Luồng công việc nhiều hàm”; chuẩn bị “Nối Flatmap với Filter”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Spark: Map và Flatmap”; chuẩn bị “Đánh giá lười và dòng dõi”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** SVG có nhãn và chiều luồng.
...
- **Kết nối vào–ra:** từ “Nối Flatmap với Filter”; chuẩn bị “Vai trò lưu trữ và thực thi”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Đánh giá lười và dòng dõi”; chuẩn bị “2.5 · Quy ước tính chi phí”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Vai trò lưu trữ và thực thi”; chuẩn bị “Cộng dữ liệu mà mỗi tầng nhận”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “2.5 · Quy ước tính chi phí”; chuẩn bị “Đếm từ: theo dữ liệu qua hai tầng”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** SVG có nhãn và chiều luồng.
...
- **Kết nối vào–ra:** từ “Cộng dữ liệu mà mỗi tầng nhận”; chuẩn bị “Ma trận–vector: đếm đầu vào từng tầng”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Đếm từ: theo dữ liệu qua hai tầng”; chuẩn bị “Chi phí đọc lặp dải vector”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Ma trận–vector: đếm đầu vào từng tầng”; chuẩn bị “Tổng chi phí và tải lớn nhất”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
- **Nguồn:** MMDS, 2.3.2, 2.5.1 và Bài tập 2.5.1(a), trang in 32,54–55,59.
...
- **Kết nối vào–ra:** từ “Chi phí đọc lặp dải vector”; chuẩn bị “2.6 · Tìm các cặp ảnh tương tự”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Tổng chi phí và tải lớn nhất”; chuẩn bị “Đầu vào mỗi reducer và số lần sao chép”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “2.6 · Tìm các cặp ảnh tương tự”; chuẩn bị “Mỗi reducer xử lý một cặp ảnh”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Đầu vào mỗi reducer và số lần sao chép”; chuẩn bị “Gom nhóm để dùng lại mỗi ảnh”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
- **Nguồn:** MMDS, Chương 2, 2.6.2, trang in 62–63.
...
- **Kết nối vào–ra:** từ “Mỗi reducer xử lý một cặp ảnh”; chuẩn bị “Bao phủ mọi cặp, mỗi cặp đúng một nơi”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Gom nhóm để dùng lại mỗi ảnh”; chuẩn bị “Đánh đổi cần kiểm tra trước khi triển khai”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** SVG có nhãn và chiều luồng.
...
- **Kết nối vào–ra:** từ “Bao phủ mọi cặp, mỗi cặp đúng một nơi”; chuẩn bị “2.7 · Từ lưu trữ đến đánh giá thuật toán”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Đánh đổi cần kiểm tra trước khi triển khai”; chuẩn bị “Kiểm tra bằng sản phẩm học tập”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “2.7 · Từ lưu trữ đến đánh giá thuật toán”; chuẩn bị “2.8 · Tài liệu tham khảo”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
...
- **Kết nối vào–ra:** từ “Kiểm tra bằng sản phẩm học tập”; chuẩn bị “Bài 2.2.1, bắt đầu recitation”. Mạch giảng bỏ qua các slide recitation tới cuối buổi.
- **Cách thể hiện:** Bảng, giả mã hoặc công thức theo từng bước; diễn giải và đáp án trong notes.
