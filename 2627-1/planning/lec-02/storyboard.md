...
| Hình thức hóa | B02–B05 | Vết chạy B01 | Kiểu khóa, kiểu giá trị, bảo đảm nhóm, điều kiện trước và sau |
...
Không có bước `không áp dụng`. B01 dùng trường hợp nhỏ để chạy tay nhưng giữ lại đúng cấu trúc đầu ra của tình huống A00–A03. A00 không nêu số byte vì nguồn không cung cấp số liệu cho kho được chọn.
...
| A00 | Kho Web hơn 400 TB làm một lượt đọc trên một máy mất khoảng bốn tháng | MMDS slides 4, 8, 12; MMDS 2.1, 2.2.1 | Cần lưu trữ phân tán | 2 |
...
| B05 | Điều kiện trước, sau và biên tách khỏi cài đặt | MMDS 2.2.1–2.2.3 | Chứng minh | 4 |
| B06 | Tính đúng theo song ánh đóng góp và bất biến tổng | Suy ra trực tiếp từ MMDS Ví dụ 2.1–2.2 | Kiểm tra vết chạy | 5 |
...
| C05 | Gộp reducer trong task khác với lập lịch task lên máy | MMDS trang in 28–29 | Kiểm tra 10 và 10.000 task | 3 |
| C06 | Người học tự tìm trạng thái cho phép tính trung bình | MMDS 2.2.4; liên hệ Bài 2.3.1(b) | Sang thực thi chịu lỗi | 3 |
| D00 | Chạy lại tác vụ cần kết quả phụ thuộc đầu vào | MMDS 2.2.5–2.2.6 | Theo dõi trạng thái | 2 |
...
| D03 | Giáo trình và slide MMDS đếm I/O tác vụ theo hai quy ước | MMDS slides 38–40; MMDS 2.5.1 | Xác định tác động của bộ kết hợp | 5 |
| D04 | Bộ kết hợp có thể giảm kích thước dữ liệu trung gian $M$ | MMDS 2.2.4, 2.5.1 | Kiểm tra với lỗi | 4 |
| D05 | Thực thi lại làm phát sinh I/O ngoài mô hình lý tưởng | MMDS 2.2.6 | Sang ngăn xếp | 3 |
| E00 | MapReduce là một tầng thực thi | MMDS 2.4; Stanford 50–53 | Mở các tầng ngăn xếp | 2 |
| E01 | HDFS, Hadoop MapReduce và Spark giữ các vai trò cụ thể trong ngăn xếp | MMDS 2.4; Stanford 51–59 | Chọn phạm vi phù hợp | 5 |
| E02 | MapReduce phù hợp quét tuần tự theo lô | MMDS slides 9, 12–14; MMDS 30–31; Stanford 50, 66 | Đúc thành khuôn đặc tả | 4 |
| E03 | Năm bước đặc tả nối tính đúng với chi phí | Tổng hợp nguồn đã dùng | Kiểm tra lựa chọn | 4 |
| E04 | Ba tình huống MMDS dùng khóa từ, máy chủ hoặc chuỗi năm từ | MMDS slides 12, 34–35 | Kết phần giảng | 4 |
| **Tổng** |  |  |  | **120** |

Sau mỗi phần, trang đầu phần kế tiếp nhắc đúng sản phẩm vừa tạo: A03 truyền khóa sang B00; B06 truyền điều kiện đúng sang C00; C01–C06 truyền $M$ sang D03; D03 truyền mô hình chi phí sang E02.
...
| R06 | Gộp hai ý (a–b) trên một trang, không thêm yêu cầu bộ kết hợp | Bài 2.3.1(a–b), trang in 40, PDF 21 | Có đáp án và thang 8 điểm | 14 |
| R07 | Dịch sát ý (c), không thêm sản phẩm | Bài 2.3.1(c), trang in 40, PDF 21 | Có đáp án và thang 4 điểm; đầu ra $(khóa\ không\ dùng,x)$ | 6 |
| R08 | Dịch sát ý (d), không thêm sản phẩm | Bài 2.3.1(d), trang in 40, PDF 21 | Có đáp án và thang 5 điểm | 8 |
| **Tổng** |  |  |  | **60** |

Hai ý 2.3.1(a–b) được gộp vì cùng yêu cầu thiết kế MapReduce cho một tệp số nguyên; lời giải vẫn tách rõ. Các nhãn “Sản phẩm” đã được bỏ khỏi R01–R08 để mặt trang chỉ giữ nguyên yêu cầu toán học của MMDS. Hướng dẫn chấm chỉ nằm trong ghi chú diễn giả.
...
- Gộp sơ đồ hệ tệp và vị trí dữ liệu thành SVG A01; không giữ kích thước khối định lượng vì không cần cho lập luận.
