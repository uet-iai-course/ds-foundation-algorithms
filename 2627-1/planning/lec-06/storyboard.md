...
- Mở bài (P00–M02): tình huống Ví dụ 3.10 → bài toán đầu vào/đầu ra → tiêu chí bộ lọc. Đầu vào là chữ ký MinHash của Bài 5; đầu ra là bài toán lọc cặp truyền cho mạch phân dải.
...
- Tạo ứng viên: vấn đề A00 → trực giác luồng A01 → ví dụ trạng thái A02 → đặc tả A03 → bất biến giai đoạn sinh cặp A04 → chi phí, bộ nhớ và đối chiếu A05. Giai đoạn gom ngăn hoàn tất trước khi áp dụng bất biến ở A04. Đầu vào là $q(s)$; đầu ra là thuật toán và chi phí, dẫn sang mạch họ LSH khi cần ngôn ngữ chung cho các độ đo khác.
...
- Các độ đo dùng chu trình rút gọn D00–D04 vì Hamming, góc và Euclid là tiên quyết: mỗi trang nối trực giác hình học với hàm băm, xác suất và trường hợp biên. Đầu vào là định nghĩa họ LSH; đầu ra là ba họ cụ thể truyền cho ví dụ mô hình vân tay.
...
- Kết luận C00 là mạch giảng thứ sáu và là section riêng: đầu vào là năm mạch trước; đầu ra là quy trình ba quyết định và kết nối sang Bài 7.
...
| B06 | 3 | Kiểm tra trường hợp biên; nói đánh đổi theo ngưỡng, không tuyên bố đơn điệu chung. | $b,r$ → đánh đổi theo ngưỡng $\tau$ | suy ra từ §3.4 |
...
| C00 | 2 | Section kết luận riêng: gom quyết định thiết kế, nối sang đối chiếu và Bài 7. | độ đo, họ băm, $b,r,\tau$ → quy trình | MMDS §§3.4,3.6–3.8; `sources/source.md` |
...
|---|---:|---|---|---|
| R00 | 0 | Mở phần; nêu ba sản phẩm nhóm; hướng dẫn làm trước rồi mới mở notes. | không áp dụng | MMDS Ch.3 |
...
- Kết nối MapReduce: A05 và R00 nhắc mô hình hai công việc từ Bài 2; thiết kế khóa–giá trị cụ thể là nhiệm vụ Bài tập 3.4.4 ở recitation.
