...
Bài dùng lại phép lặp PageRank của Bài 3, chỉ thay vector dịch chuyển để tạo xếp hạng theo chủ đề. Cùng cơ chế đó dẫn đến TrustRank, còn cụm thao túng liên kết cho thấy điểm toàn cục có thể bị dồn bằng cấu trúc liên kết. HITS đổi cả đầu ra lẫn quy ước ma trận: hai vector trên đồ thị con truy vấn, hàng của $L$ là nút nguồn. Trang Z01 buộc người học chọn mô hình theo mục tiêu thay vì coi bốn tên là các biến thể tương đương.
...
| T04 | 5 | Bảng đóng góp cạnh, dịch chuyển và kết quả một vòng | MMDS Ví dụ 5.10 |
...
| S03 | 4 | Luồng hạng qua một trang hỗ trợ | MMDS §5.4.2 |
| S04 | 5 | Suy ra công thức chính xác với $N,q$ | Tính lại từ hệ nguồn |
| S05 | 5 | Ví dụ 5.11, xấp xỉ, sai số và kiểm tra ba nguồn hạng | MMDS Ví dụ 5.11 |
| K00 | 3 | TrustRank là PageRank theo chủ đề; hiện $q_T$ và phương trình | MMDS §5.4.3–5.4.4 |
| K01 | 4 | Hai cách chọn hạt giống | MMDS §5.4.4 |
| K02 | 3 | Giới hạn của tập tin cậy | MMDS §5.4.4 |
| K03 | 4 | Đặc tả khối lượng rác | MMDS §5.4.5 |
| K04 | 5 | Bảng Hình 5.17 và hai quy ước nguồn trên mặt trang | MMDS Hình 5.17 |
| K05 | 4 | Kiểm tra dấu và giới hạn diễn giải | MMDS §5.4.5 |
| H00 | 3 | Đồ thị con thưa của kết quả truy vấn; không dựng ma trận đặc toàn Web | MMDS §5.5 |
| H01 | 3 | Trực giác hai vai trò | MMDS §5.5.1 |
| H03 | 4 | Hình 5.18 và chạy tay hai tổng trên cạnh trước ma trận | MMDS Hình 5.18 |
| H02 | 4 | Quy ước $L$ hàng nguồn, khác $P$; nối từ tổng trên cạnh | MMDS §5.5.2 |
| H04 | 3 | Chỉ hiển thị $L$ của Hình 5.19; đọc $L^T$ bằng chuyển vị | MMDS Hình 5.19 |
| H06 | 4 | Vòng 1 của Hình 5.20 | MMDS Hình 5.20 |
| H07 | 4 | Vòng 2 của Hình 5.20 | MMDS Hình 5.20 |
| H05 | 5 | Giả mã sau ví dụ; dừng, cờ và hai nhánh vector 0 trên mặt trang | MMDS §5.5.2, bổ sung đặc tả |
...
| Z01 | 3 | So sánh $P$ chia bậc với $L,L^T$ Boolean | Tổng hợp §5.3–5.5 |
...
|---|---:|---|
| R01 | 18 | MMDS Bài 5.3.1, trang in 199, PDF 25: chia hai ý giữa nhóm rồi đối chiếu hai vector |
| R02 | 3 | Dữ kiện MMDS Bài 5.4.2: đồ thị trung tính, ma trận $P$ và PageRank cơ sở |
| R03 | 19 | MMDS Bài 5.4.2, trang in 204, PDF 30: TrustRank và khối lượng rác khi chỉ B tin cậy |
| R04 | 20 | MMDS Bài 5.5.1, trang in 208, PDF 34: phân nhóm theo vết và lặp có ngưỡng $10^{-3}$ |
| **Tổng** | **60** |  |
...
- K05 → H00: TrustRank vẫn cho một điểm; HITS tách hai vai trò trong ngữ cảnh truy vấn.
...
- T03 cung cấp cạnh và tập $S$; T04 giữ riêng đóng góp cạnh, dịch chuyển và tổng để sinh viên kiểm tra từng phần.
- S02 cố định $N,q,x,y$; S03–S05 không quay lại ký hiệu $n,m$ của sách.
- H03 chuyển hai tổng trên cạnh sang quy ước hàng nguồn ở H02, ma trận H04 và hai bảng vết H06–H07; H05 khái quát đúng trạng thái đã thấy.
